...
def OnSelected(event):
    ...
    lbl_title = Label(FormTitle, text="Updating Contacts", font=('arial', 16), bg="green orange", width=300)
...
lbl_title = Label(Top, text="Guest Details List", font=('arial', 16), width=500, bg='yellow')
lbl_title.pack(fill=X)
